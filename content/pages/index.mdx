...
I work where mathematical structure meets computational systems. My current questions move between <RecentProjectTopics />—fields connected by a shared interest in representation, inference, and what can be known from incomplete information.
